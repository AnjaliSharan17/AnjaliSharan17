...
* ⚙️ Strong in building APIs, databases, and scalable systems
* 🚀 Focused on writing clean, efficient, and production-ready code
* 🌱 Currently improving system design and distributed systems knowledge
...
* Built a scalable chat system using WebSockets
* Implemented authentication and real-time messaging
* Tech: Node.js, Socket.io, Redis

### 🔹 URL Shortener with Analytics

* Designed a backend system for generating and tracking short URLs
* Includes click analytics and caching
